...
<div class="float_div">
	<div class="float_div_bg">
	  ...
	  <a rel="nofollow" target="_blank" href="https://www.dituwuyou.com/map/viewer?mid=oTYlizSY-dBPttvQRr0iag" class="float_link" id="fl3"></a>
			...
			<c:if test="<%=user==null %>">
				<li id="nav_4"><a rel="nofollow" class="nav_a" href="<%=path%>/hui-jxs/userlogin.jsp"><span>LOGIN</span>登录注册 </a>
				     <div class="nav_child">
						 ...
						 <a rel="nofollow" href="<%=path%>/hui-jxs/userlogin.jsp">用户经销商注册 </a>					
					 </div>			 
				</li>
			</c:if>
			<c:if test="<%=user!=null %>">
...
<div id="main">
  ...
  <div class="kv" >
      <div class="flexslider">
		<ul class="slides">
<%-- 		  <li style="background:url(<%=path %>/homeimage/55a373ac4f253.jpg) 50% 0 no-repeat;cursor:pointer;"></li> --%>
<%-- 		  <li style="background:url(<%=path %>/homeimage/55a37216a6733.jpg) 50% 0 no-repeat;cursor:pointer;"></li> --%>
<%-- 		  <li style="background:url(<%=path %>/homeimage/55a371984ade0.jpg) 50% 0 no-repeat;cursor:pointer;"></li>		 --%>
		  <li style="background:url(<%=path %>/homeimage/big3.jpg) 50% 0 no-repeat;cursor:pointer;"></li>		
		  <li style="background:url(<%=path %>/homeimage/big1.jpg) 50% 0 no-repeat;cursor:pointer;"></li>
		  <li style="background:url(<%=path %>/homeimage/big2.jpg) 50% 0 no-repeat;cursor:pointer;"></li>
		</ul>
	  </div>
</div>
 <!--banner-->
  <div class="content">
    <div class="public box_1">
      <div class="fl">
        <span class="bt">楼盘搜索 | <span>REAL ESTATE QUERY</span></span>
      ...
      <div class="fr">
        ...
        <p> &nbsp;<a href="https://www.dituwuyou.com/map/viewer?mid=oTYlizSY-dBPttvQRr0iag" rel="nofollow" target="_blank"><img src="<%=path%>/homeimage/map.jpg" alt="中国房产中国地图" /></a><br /></p> </div>
      <div class="clr"></div>
    </div>
    <div class="hot">
    ...
    <div class="alink">
      <ul class="media_hide">
        <li>
        	<a href="javascript:void(0);" target="_blank"><img alt="中国房产业务咨询" src="<%=path %>/homeimage/phone.png"/></a>
          	<p>业务咨询<br/>
            <b>156-7976-0329</b></p>
        </li>
...
﻿<div class="bottom_box">
	...
	<div class="bottom">
		<div class="bottom_m">
			...
			<p id="bottom_menu1" style="padding-top:18px;">
