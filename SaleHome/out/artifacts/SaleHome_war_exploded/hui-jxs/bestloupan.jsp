	  ...
	  <div class="nav">
		<div class="nav_main">
		  <ul>
			...
			<li id="nav_4"><a rel="nofollow" class="nav_a" href="<%=path%>/hui-jxs/aboutwe.jsp"><span>ABOUT  US</span>关于我们 </a>
			     <div class="nav_child">
			...
			<c:if test="<%=user==null %>">
				<li id="nav_5"><a rel="nofollow" class="nav_a" href="<%=path%>/hui-jxs/userlogin.jsp"><span>LOGIN</span>登录注册 </a>
				     <div class="nav_child">
    ...
    <div class="tab">
      <div class="tab_box">
        <ul class="tab_box_top">
        	  <c:forEach items="${loupanlist}" var="l" begin="1" end="4">
				  <li id="tab17">
		...
		<div style="height:60px;background:#0260a6">
			...
			<ul class="tab_box_top">
			  <li id="tab17">
			  	<a href="<%=path%>/facemain/bestloupan?currentpage=1&handle=firstpage">←首页</a>
			  </li>
			  <li id="tab17">
			  	<a href="<%=path%>/facemain/bestloupan?currentpage=${pager.currentpage}&handle=uppage">←上一页</a>
			  </li>
			  <li id="tab17">
			  	<a href="<%=path%>/facemain/bestloupan?currentpage=${pager.currentpage}&handle=downtpage">←下一页</a>
			  </li>
			  <li id="tab17">
			  	<a href="<%=path%>/facemain/bestloupan?currentpage=${pager.sumpage}&handle=lastpage">←尾页</a>
			  </li>	
			</ul>			
		</div>  
	</div>
				  ...
				  <div class="media_show">
					...
					<div class="form" style="margin:0px;">
					    <form action="/iinvestment/fildform.html" method="post" id="iiform">
					      ...
					      <div class="bt"><img src="<%=path %>/homeimage/c_bt.gif" border="0" alt="索取中国房产投资报告"/></div>
					      <div class="form_left">
					        <ul>
					          <li>
