...
<article class="page-container">
	<form class="form form-horizontal" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/ld/addloudong" method="post">
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>所属楼盘：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>楼栋名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" required  onblur="checkname(this.value);" placeholder="请输入楼栋名称" id="loudong_nameString" name="loudong.nameString">
				<span style="display:none;color:#ff0033;align:center;font-size:4px;height:8px" id="nameString" ></span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>楼栋总层：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text"  required style="width:26.5em" autocomplete="off" value="" placeholder="请输入楼栋总层数" onblur="checktotal(this.value);" id="loudong_totalFloorInt" name="loudong.totalFloorInt">
				<span style="display:none;color:#ff0033;align:center;font-size:4px;height:8px" id="total" ></span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>电梯总数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  style="width:26.5em"  autocomplete="off"  onblur="checklift(this.value);" placeholder="请输入楼栋电梯总数" id="loudong_totalLiftInt" name="loudong.totalLiftInt">
				<span style="display:none;color:#ff0033;align:center;font-size:4px;height:8px" id="lift" ></span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>每层户数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  style="width:26.5em"  value="" placeholder="请输入每层户数" onblur="checkfloor(this.value);" id="loudong_floorRoomsInt" name="loudong.floorRoomsInt">
