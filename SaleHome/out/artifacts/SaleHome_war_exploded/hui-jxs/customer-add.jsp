	...
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/customer/addcustomer" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" required  onblur="checknameString(this.value);" placeholder="请输入真实姓名" id="customer_nameString" name="customer.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="customer.genderString" required  type="radio" value="男" id="sex-1" checked>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" value="" required  onblur="checkbirthday(this.value);" placeholder="请输入客户生日" id="customer_birthday" name="customer.birthday">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="" required  style="width:39.3em" onblur="checkeidentityIdString(this.value);" placeholder="请输入客户身份证号" id="customer_identityIdString" name="customer.identityIdString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="email" class="input-text" value="" required  onblur="checkemailString(this.value);" placeholder="请输入客户邮箱地址" id="customer_phoneString" name="customer.emailString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="" required  style="width:39.3em"  onblur="checkphoneString(this.value);" placeholder="请输入客户联系方式" id="customer_phoneString" name="customer.phoneString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" required  onblur="checktogenameString(this.value);" placeholder="请输入真实姓名" id="customer_togenameString" name="customer.togetherString">
