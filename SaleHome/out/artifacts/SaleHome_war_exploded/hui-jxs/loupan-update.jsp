...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<%=path%>/lp/addloupan" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="loupan.logoString" value="${loupan.logoString}" id="logoString1"/>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text" required   value="${loupan.nameString}" placeholder="请输入楼盘的名称" id="loupan.nameString" name="loupan.nameString">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-4">
				<input type="number" min="0"  style="width:25em" class="input-text" required  value="${loupan.floorAreaString}" placeholder="请输入楼盘的占地面积" id="loupan.floorAreaString" name="loupan.floorAreaString">
			</div>
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>建筑面积：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="number" min="0" style="width:18.3em" class="input-text" required  value="${loupan.buildingAreaString}" placeholder="请输入楼盘的建筑面积" id="loupan.buildingAreaString" name="loupan.buildingAreaString">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-4">
				<input type="text" class="input-text" required  value="${loupan.areaString}" placeholder="请输入楼盘的区域" id="city" name="loupan.areaString">
			</div>
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>楼盘均价：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="number"  style="width:18.5em" class="input-text" min="0" required value="${loupan.avgPriceDouble}" placeholder="请输入楼盘均价" id="loupan.avgPriceDouble" name="loupan.avgPriceDouble"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>开发公司：</label>
			<div class="formControls col-xs-2 col-sm-4">
				<input type="text" class="input-text" required  value="${loupan.companyString}" placeholder="请输入楼盘的开发公司" id="loupan.companyString" name="loupan.companyString">
			</div>
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>开盘时间：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" style="width:258px" required  placeholder="请输入楼盘的开发时间"  value="${loupan.openDate}" id="loupan.openDate" name="loupan.openDate" class="input-text easyui-datetimebox">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>总套数：</label>
			<div class="formControls col-xs-3 col-sm-4">
				<input type="text" class="input-text" required  value="${loupan.totalRoomsInt}" placeholder="请输入楼盘的总套数" id="loupan.totalRoomsInt" name="loupan.totalRoomsInt">
			</div>
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>接待地址：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text" required  value="${loupan.receptionAddressString}" placeholder="请输入楼盘客户接待地址" id="loupan.receptionAddressString" name="loupan.receptionAddressString">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>售楼热线：</label>
			<div class="formControls col-xs-3 col-sm-4">
				<input type="number" style="width:25em" class="input-text"  required  value="${loupan.telString}" placeholder="请输入楼盘的售楼联系方式" id="loupan.telString" name="loupan.telString">
			</div>
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>绿化率：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<span class="select-box">
				<select name="loupan.greenRatioDouble" required  class="select">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-4">
				<input type="number" style="width:25em" class="input-text" required min="0" max="100" value="${loupan.plotRatioDouble}" placeholder="请输入楼盘的容积率(单位%)" id="loupan.plotRatioDouble" name="loupan.plotRatioDouble">
			</div>
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>物业公司：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text" required  value="${loupan.propertyCompany}" placeholder="请输入楼盘物业公司" id="loupan.propertyCompany" name="loupan.propertyCompany">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>物业费用：</label>
			<div class="formControls col-xs-3 col-sm-4">
				<input type="text" class="input-text" required min="0" value="${loupan.propertyFeeDouble}" placeholder="请输入楼盘的物业费用" id="loupan.propertyFeeDouble" name="loupan.propertyFeeDouble">
			</div>
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>车位总数：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="number" style="width:18.3em" class="input-text" min="0" required  value="${loupan.carStationInt}" placeholder="请输入楼盘的车位总数" id="loupan.carStationInt" name="loupan.carStationInt">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>交通状况：</label>
			<div class="formControls col-xs-3 col-sm-4">
				<input type="text" class="input-text" required  value="${loupan.trafficString}" placeholder="请输入楼盘的交通状况" id="loupan.trafficString" name="loupan.trafficString">
			</div>
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>周边配套：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text" required  value="${loupan.equipmentsString}" placeholder="请输入楼盘的周边配套" id="loupan.equipmentsString" name="loupan.equipmentsString">
			</div>
		</div>
		<div class="row cl">
