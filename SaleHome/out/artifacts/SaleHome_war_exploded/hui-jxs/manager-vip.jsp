...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/manager/updatesavemanager" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="house.introString" required  cols="" id="house_introString" rows="" readonly="readonly" class="textarea"  placeholder="审核进度备注，不可编辑" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)">${manager.reasonString}</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="${manager.nameString}" onblur="checkname(this.value);" placeholder="请输入正实姓名" id="manager_nameString" name="manager.nameString">
