	...
	<form class="form form-horizontal" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/wztype/updatearticletype" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  onblur="checkname(this.value);" value="${tArticleType.nameString}" placeholder="请输入文章类别名称" id="tArticleType_nameString" name="tArticleType.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  onblur="checkedesString(this.value);" value="${tArticleType.desString}" placeholder="请输入文章类别描述" maxlength="20" id="tArticleType_desString" name="tArticleType.desString">
