...
<article class="page-container">
	<form class="form form-horizontal"  onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/sale/saveaddsale" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" required  onblur="checksaleTimeString(this.value);" placeholder="请输入销售时间" id="sale_saleTimeString" name="sale.saleTimeString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required min="0" onblur="checkunitPriceDouble(this.value);" placeholder="请输入销售单价" id="sale_unitPriceDouble" name="sale.unitPriceDouble" style="width:26.6em">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required min="0" onblur="checkdiscountDouble(this.value);" placeholder="请输入销售折扣" id="sale_discountDouble" name="sale.discountDouble" style="width:26.6em">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  onblur="checktotalCostDouble(this.value);" placeholder="请输入销售总价" id="sale_totalCostDouble" name="sale.totalCostDouble" style="width:26.6em">
