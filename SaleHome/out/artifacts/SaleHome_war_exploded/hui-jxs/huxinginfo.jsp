				...
				<div class="nav_main">
					<ul>
						...
						<li id="nav_1"><a class="nav_a"
							href="<%=path%>/facemain/bestloupan"><span>LONDON</span>中国房产 </a>
							<div class="nav_child">
						...
						<li id="nav_3"><a class="nav_a"
							...
							<div class="nav_child">
								...
								<a href="<%=path%>/hui-jxs/question.jsp">买房常见问题 </a> 					  <a  href="<%=path%>/facemain/buyhouseliucheng">中国买房流程 </a>
								...
								<c:forEach items="${employeelist}" var="e">
									<li><a
										href="javascript:void(0);">
											<img alt="${e.nameString}" src="<%=path %>/${e.headiconString}"
											border="0" />
											<div class="li_bg">
												<img src="<%=path%>/homeimage/q_l.png" alt="${e.nameString}员工" />
											</div>
									</a>
										<p>
