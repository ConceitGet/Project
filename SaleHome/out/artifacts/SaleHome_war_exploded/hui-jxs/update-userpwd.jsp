...
<article class="page-container">
	<form action="<%=path %>/user/updateuserpwd" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
...
function closenow(){
	...
	if(newpwd==""){
		...
		$.post(
			"${pageContext.request.contextPath}/user/initpwd",
			{
			},
			function(data){
				if(data!=newpwd){
	...
	$.post(
		"${pageContext.request.contextPath}/user/updateuserpwd",
		{
