...
<article class="page-container">
	<form class="form form-horizontal" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/room/addroom" method="post">
		<input type="hidden" name="room.buildingIdString" value="" id="buildid"/>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  required  value="" onblur="checkname(this.value);" placeholder="请输入房号名称" id="room_nameString" name="room.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="room.roominfoString" required  cols="" id="room_roominfoString" rows="" class="textarea"  placeholder="说点什么...500个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,500)"></textarea>
...
<script type="text/javascript">
	...
	$("#build_buildidString").change(function(){
		$("#buildid").val($("#build_buildidString").val());
