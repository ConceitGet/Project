	...
	<form action="<%=path %>/yg/updatepwd" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-8">
				<input type="password"  required  class="input-text" onblur="checkpwd(this.value);" autocomplete="off" placeholder="不修改请留空，旧密码" name="an" id="new">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-8">
				<input type="password" required  class="input-text" onblur="checkonepwd(this.value);" autocomplete="off" placeholder="不修改请留空" name="newpassword" id="newpassword">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-8">
				<input type="password" required  class="input-text" onblur="checktwopwd(this.value);"  autocomplete="off" placeholder="不修改请留空" name="newpassword2" id="newpassword2">
