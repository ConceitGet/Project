...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/jxs/uplogo" method="post">
		<input type="hidden" name="tagency.idString" value="${tagency.idString}" />
		<input type="hidden" name="tagency.logoString" value="${tagency.logoString}" />
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">原商标：</label>
			<div class="formControls col-xs-8 col-sm-9">
					<img src="<%=path%>/${tagency.logoString}" style="width:200px;height:200px;border-radius:100%"/>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">商标：</label>
