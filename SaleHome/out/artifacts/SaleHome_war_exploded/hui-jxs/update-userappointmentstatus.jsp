...
<article class="page-container">
	<form class="form form-horizontal" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/appointment/updateuserappointment" method="post">
		...
		<div class="row cl" id="time">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" style="width:368px" required  placeholder="请输入看房时间"   id="openDate" name="appointment.arriveTime" class="input-text  easyui-datetimebox">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3">操作备注：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="appointment.reasonString" required  cols="" id="appointment_reasonString" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)"></textarea>
