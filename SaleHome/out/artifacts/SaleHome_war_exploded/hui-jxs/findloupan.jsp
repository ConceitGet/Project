  ...
  <div class="nav_box">
	  <div class="nav">
		...
		<div class="home_top">
			<div class="w_626">
				<div class="img">
					<img src="<%=path %>/homeimage/h_1.png" border="0" alt=""/>
				</div>
				<p>
					搜索结果 | <span>SEARCH RESULTS</span>
				</p>
							...
							<c:if test="${requestScope.num!=0}">
								<ul class="home_main">
									<c:forEach items="${loupanlist}" var="l">
										<li><a
											href="<%=path%>/facemain/facemaininfo?loupan.idString=${l.idString}">
												<img src="<%=path %>/${l.logoString}" border="0" />
												<div class="li_bg">
													<img src="<%=path%>/homeimage/q_l.png" />
												</div>
										</a>
											<p>
												<b>${l.nameString}..</b><br /> 均价： <strong>￥${l.avgPriceDouble}/(平米)起</strong><br />
												地区： ${l.addressString}<br /> 售楼TEL：<span>${l.telString}..</span><br /></li>
									</c:forEach>
								</ul>
							</c:if>
						</div>
			...
			<div class="public box_2">
				<div class="public box_2">
					...
					<div class="fr media_hide">
						<h2 class="bt">
							买房常见问题 | <span>QUESTIONS</span>
						</h2>
						<ul class="qu">
							<li><a title="购房有保障吗？"
								href="/iinvestment/content/id/24/pid/3/newsid/107.html">购房最新的的行情是什么？</a>
								<p>不知道怎么选房，可以寻找经销商的员工进行交流帮助...</p></li>
							<li><a title="中国金融城之二，金丝雀码头Canary Wharf 详情介绍"
								href="/iinvestment/content/id/24/pid/3/newsid/108.html">中国金融城之二，金丝雀码头Canary
									Wharf 详情介绍</a>
								<p>...</p></li>
							<li><a title="中国金融城之三，潜力之地亚洲金融港ABP"
								href="/iinvestment/content/id/24/pid/3/newsid/109.html">中国金融城之三，潜力之地亚洲金融港ABP</a>
								<p>...</p></li>
						</ul>
					</div>
					<div class="clr"></div>
					<div class="media_show">
						...
						<div class="form" style="margin: 0px;">
							<form action="/iinvestment/fildform.html" method="post"
								id="iiform">
								<input type="hidden" name="fileids" id="fileids" />
								<div class="bt">
									<img src="/Apps/Tpl/default/Public/images/c_bt.gif" border="0"
										alt="索取中国房产投资报告" />
								</div>
								<div class="form_left">
									<ul>
		...
		<div class="bottom_ul_li">
			<ul>
				...
				<li id="b_about"><a rel="nofollow"
					href="/about/index/id/6/pid/5.html">我们</a></li>
			</ul>
