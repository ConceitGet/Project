...
<activity class="page-container">
	<form class="form form-horizontal" onsubmit="return check();" enctype="multipart/form-data" id="form-activity-add" method="post" action="<%=path%>/activity/updatesaveactivity">
		<input type="hidden" name="activity.addressString" id="addr" value="${activity.addressString}"/>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="${activity.titleString}" placeholder="请输入活动标题" id="activity_titleString" name="activity.titleString">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>开始时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" required  class="input-text  easyui-datetimebox" value="${activity.startTime}" placeholder="请输入活动开始时间" id="activity_startTime" name="activity.startTime">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>结束时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" required  class="input-text  easyui-datetimebox" value="${activity.endTime}" placeholder="请输入活动结束时间" id="activity_endTime" name="activity.endTime">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">活动内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<textarea name="activity.contentString" required  id="editor" style="width:100%;height:400px;">${activity.contentString}</textarea>
			</div>
		</div>
		<div class="row cl">
