	...
	<form class="form form-horizontal" onsubmit="return checkvolid();" enctype="multipart/form-data" id="form-admin-add" action="<%=path%>/user/ruzhu" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="" placeholder="请输入经销商名称" id="tagency_nameString" onblur="checknameString(this.value);" name="tagency.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="" placeholder="请输入经销商负责人" id="tagency_leaderString" onblur="checkleaderString(this.value);" name="tagency.leaderString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  value="" placeholder="请输入经销商的固定电话" onblur="checktelString(this.value);" style="width:60em"  id="tagency_telString" name="tagency.telString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="tagency.introString" required  cols="" id="tagency_introString" rows="" class="textarea"  placeholder="说点什么...350个字符以内" dragonfly="true" onKeyUp="checkinfo(this.value);"></textarea>
				<p class="textarea-numberbar"><em class="textarea-length" id="number">0</em>/350</p>
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
	function checkinfo(name){
		if(name.length<=350){
			...
			$("#tagency_introString").val(name.substring(0,350));
			return;
		}
