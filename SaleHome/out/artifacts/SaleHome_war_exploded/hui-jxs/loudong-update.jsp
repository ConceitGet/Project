...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="<%=path%>/ld/addloudong" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="${loudong.nameString}" placeholder="请输入楼栋名称" id="loudong_nameString" name="loudong.nameString">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>楼栋总层：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  required autocomplete="off" value="${loudong.totalFloorInt}" placeholder="请输入楼栋总层数" id="loudong_totalFloorInt" name="loudong.totalFloorInt">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>楼栋电梯总数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  autocomplete="off" value="${loudong.totalLiftInt}"  placeholder="请输入楼栋电梯总数" id="loudong_totalLiftInt" name="loudong.totalLiftInt">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>每层户数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="${loudong.floorRoomsInt}" placeholder="请输入每层户数" id="loudong_floorRoomsInt" name="loudong.floorRoomsInt">
			</div>
		</div>
		<div class="row cl">
