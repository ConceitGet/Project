...
<article class="page-container">
	<form class="form form-horizontal" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/wztype/addarticletype" method="post">
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>文章类别名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  onblur="checkname(this.value);" placeholder="请输入文章类别名称" id="tArticleType_nameString" name="tArticleType.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  onblur="checkedesString(this.value);" placeholder="请输入文章类别描述" maxlength="20" id="tArticleType_desString" name="tArticleType.desString">
