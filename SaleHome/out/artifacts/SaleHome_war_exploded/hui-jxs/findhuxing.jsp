	  ...
	  <div class="nav">
		<div class="nav_main">
		  <ul>
			...
			<li id="nav_2"><a class="nav_a" href="<%=path%>/facemain/othersloupan"><span>MORE CITIES</span>其他城市 </a>
			     <div class="nav_child">
							...
							<c:if test="${requestScope.num!=0}">
								<ul class="home_main">
									<c:forEach items="${houselist}" var="l">
										<li><a
											href="<%=path%>/facemain/houseinfo?house.idString=${l.idString}&loupan.idString=${param.id}">
											...
											<p>
												<b>${l.nameString}..</b><br /> 售价： <strong>￥${l.unitPriceDouble}/(平米)起</strong><br /><br/></br>
												面积： ${l.areaDouble}<br /></li>
									</c:forEach>
