...
<article class="page-container">
	<form class="form form-horizontal" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/mission/addsavemission" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  onblur="checkphone(this.value);" placeholder="请输入员工的任务量" id="mission_quantityInt" name="mission.quantityInt" style="width:26.1em">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text"  required  onblur="checkwechatString(this.value);" placeholder="请输入员工完成的任务的月份" id="mission_monthesint" style="width:26.1em" name="mission.monthesint">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text"  required  onblur="checkqq(this.value);" placeholder="请输入员工的提成销售比例" id="mission_bonusPercentDouble" name="mission.bonusPercentDouble"  style="width:26.1em">
