					  ...
					  <ul id="myTab" class="nav nav-tabs">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane fade in active" id="login">
								<form class="form-horizontal"  role="form" id="form" onsubmit="pwd();" action="<%=path %>/lr/loginsuccess">
				                      ...
				                      <div class="form-group help">
				                          ...
				                          <span class="btn btn-primary btn-lg fa-question-circle glyphicon glyphicon-info-sign" style="margin-top:0px"><a href="<%=path%>/hui-jxs/findloginpwd.jsp"><font color="white">忘记密码</font></a></span>
				                      </div>
				                      <div class="form-group">
				                          ...
				                          <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;还没有SaleHome账号？<a href="<%=path%>/hui-jxs/findloginpwd.jsp">忘记密码</a></label>
				                          <div class="form-group">
				                      	  </div>
    ...
    <script>
    	$(function(){
    		...
    		$("#getcode").click(function(){
    			...
    			$.post(
   					"${pageContext.request.contextPath}/lr/regssendcode",
   					{
