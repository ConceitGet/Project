	...
	<form class="form form-horizontal" id="form-admin-add" action="<%=path%>/jxs/addtagency" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="${tagency.nameString}" placeholder="请输入经销商名称" id="tagency_nameString" name="tagency.nameString">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="email" class="input-text" required  autocomplete="off" value="${tagency.emailString}" placeholder="请输入经销商的email" id="tagency_emailString" name="tagency.emailString">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>手机号码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required style="width:60em" max="99999999999"  autocomplete="off" value="${tagency.phoneString}"  placeholder="请输入经销商的手机联系方式" id="tagency_phoneString" name="tagency.phoneString">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>固定电话：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required min="0" style="width:60em"  value="${tagency.telString}" placeholder="请输入经销商的固定电话" id="tagency_telString" name="tagency.telString">
			</div>
		</div>
		<div class="row cl">
