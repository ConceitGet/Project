...
<article class="page-container">
	<form class="form form-horizontal" onsubmit="return checkvolid();" enctype="multipart/form-data" id="form-admin-add" action="<%=path%>/hx/addhouse" method="post">
		...
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>户型图片：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>楼盘楼栋：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>户型名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="" onblur="checkname(this.value);" placeholder="请输入户型名称" id="house_nameString" name="house.nameString">
				<span style="display:none;color:#ff0033;align:center;font-size:4px;height:8px" id="nameString" ></span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>户型面积：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  style="width:40.3em" min="0" autocomplete="off" value="" placeholder="请输入户型面积" onblur="checktotal(this.value);" id="house_areaDouble" name="house.areaDouble">
				<span style="display:none;color:#ff0033;align:center;font-size:4px;height:8px" id="total" ></span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>参考价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  style="width:40.3em" min="0"  autocomplete="off"  onblur="checklift(this.value);" placeholder="请输入户型的参考价" id="house_unitPriceDouble" name="house.unitPriceDouble">
				<span style="display:none;color:#ff0033;align:center;font-size:4px;height:8px" id="lift" ></span>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-3"><span class="c-red">*</span>户型简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="house.introString" cols=""  required onblur="checkintroString(this.name);" id="house_introString" rows="" class="textarea"  placeholder="说点什么...300个字符以内" dragonfly="true" onKeyUp="checkinfo(this.value)"></textarea>
