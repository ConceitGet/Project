	...
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/user/adduser" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="" onblur="checknameString(this.value);" placeholder="请输入真实姓名" id="user_nameString" name="user.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="" onblur="checknicknameString(this.value);" placeholder="请输入用户昵称" id="user_nicknameString" name="user.nicknameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="email" class="input-text" required  value="" onblur="checkemailString(this.value);" style="width:58em"  placeholder="请输入用户邮箱" id="user_emailString" name="user.emailString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  value="" style="width:58em" onblur="checkphoneString(this.value);" placeholder="请输入用户联系方式" id="user_phoneString" name="user.phoneString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="" onblur="checkwechatString(this.value);" placeholder="请输入用户用户微信" id="user_wechatString" name="user.wechatString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  value="" style="width:58em"  onblur="checkqqString(this.value);" placeholder="请输入用户用户QQ" id="user_qqString" name="user.qqString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" required  value=""  onblur="checkbirthday(this.value);" placeholder="请输入用户生日" id="user_birthday" name="user.birthday">
