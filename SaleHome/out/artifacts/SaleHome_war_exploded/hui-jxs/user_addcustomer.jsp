	...
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/appointment/querenbuy" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  value="" style="width:39.3em" onblur="checkeidentityIdString(this.value);" placeholder="请输入客户身份证号" id="customer_identityIdString" name="customer.identityIdString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="" onblur="checktogenameString(this.value);" placeholder="请输入真实姓名" id="customer_togenameString" name="customer.togetherString">
