...
<article class="page-container">
	<form action="<%=path %>/manager/updatemanagerpwd" method="post" onsubmit="return checkpassword();" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-5"><span class="c-red">*</span>旧密码：</label>
			<div class="formControls col-xs-7 col-sm-8">
				<input type="password" class="input-text" required  onblur="checkpwd(this.value);" autocomplete="off" placeholder="不修改请留空，旧密码" name="an" id="new">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-8">
				<input type="password" class="input-text" required  onblur="checkonepwd(this.value);" autocomplete="off" placeholder="不修改请留空" name="newpassword" id="newpassword">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-8">
				<input type="password" class="input-text" required  onblur="checktwopwd(this.value);"  autocomplete="off" placeholder="不修改请留空" name="newpassword2" id="newpassword2">
...
function closenow(){
	...
	if(newpwd==""){
		...
		$.post(
			"${pageContext.request.contextPath}/manager/initpwd",
			{
			},
			function(data){
				if(data!=newpwd){
	...
	$.post(
		"${pageContext.request.contextPath}/manager/updatemanagerpwd",
		{
...
<script type="text/javascript">
	function info(){
		layer.msg('发送短信，编辑新密码发送到：17607975702!', {
	 		icon : 1,
	 		time : 3000
	 	});
	}
