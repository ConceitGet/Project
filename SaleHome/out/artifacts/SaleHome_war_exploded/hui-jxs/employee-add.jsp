...
<article class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvalid();" id="form-admin-add" action="<%=path%>/yg/addemployee" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  onblur="checknameString(this.value);" placeholder="请输入正实姓名" id="employee_nameString" name="employee.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="email" class="input-text" required  onblur="checkemailString(this.value);" placeholder="请输入用户邮箱" id="employee_emailString" name="employee.emailString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  onblur="checkphoneString(this.value);" placeholder="请输入用户手机号码" id="employee_phoneString" name="employee.phoneString" style="width:39.3em">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  value="" onblur="checksalary(this.value);" placeholder="请输入员工基本工资" id="employee_basicSalaryDouble" name="employee.basicSalaryDouble" style="width:39.3em">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  onblur="checkwechatString(this.value);" placeholder="请输入用户微信账号" id="employee_wechatString" name="employee.wechatString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  onblur="checkqqString(this.value);" placeholder="请输入用户QQ号码" id="employee_qqString" name="employee.qqString"  style="width:39.3em">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="employee.desString" id="employee_desString" cols="" rows="" class="textarea"  placeholder="个人简介...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="楼盘简介不能为空！" onKeyUp="checkinfo(this.value);"></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="employee.expString" id="employee_expString" cols="" rows="" class="textarea"  placeholder="工作经验简介...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="楼盘简介不能为空！" onKeyUp="checkexp(this.value);"></textarea>
