	...
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvalid();" id="form-admin-add" action="<%=path%>/manager/addmanager" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" required style="width:40em" onblur="checkphoneString(this.value);" placeholder="请输入管理员账号" id="manager_phoneString" name="manager.phoneString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" required  onblur="checkpasswordString(this.value);" placeholder="请输入管理员密码" id="manager_passwordString" name="manager.passwordString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" required  onblur="checkname(this.value);" placeholder="请输入真实姓名" id="manager_nameString" name="manager.nameString">
