			...
			<div class="container-fluid cl">
				...
				<nav id="Hui-userbar"
					...
					<ul class="cl">
						...
						<c:if test="<%=user.getNameString()!=null %>">
								<a style="cursor: pointer;text-decoration: none;" class="text-primary" onclick="info_edit('<%=user.getNameString()%>经销商','<%=path%>/user/showuser?user.idString=<%=user.getIdString() %>','<%=user.getNameString() %>','600','430')"><i class="Hui-iconfont">&#xe62d;</i><%=user.getPhoneString() %></a>
						</c:if>
