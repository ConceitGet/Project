	...
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvolid();" id="form-admin-add" action="<%=path%>/user/saveuserinfo" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="${user.nameString}" onblur="checkname(this.value);" placeholder="请输入真实姓名" id="user_nameString" name="user.nameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="${user.nicknameString}" onblur="checknickname(this.value);" placeholder="请输入用户昵称" id="user_nicknameString" name="user.nicknameString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="email" class="input-text" required  value="${user.emailString}" onblur="checkemail(this.value);" placeholder="请输入用户邮箱" id="user_emailString" name="user.emailString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  value="${user.phoneString}" onblur="checkphoneString(this.value);" placeholder="请输入用户手机号码" id="user_phoneString" style="width:59em" name="user.phoneString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" required  value="${user.wechatString}" onblur="checkwechatString(this.value);" placeholder="请输入用户微信" id="user_wechatString" name="user.wechatString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" required  value="${user.qqString}" onblur="checkqqString(this.value);" maxlength="10"  placeholder="请输入用户手机号码" id="user_qqString" name="user.qqString" style="width:59em">
