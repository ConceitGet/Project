...
<activity class="page-container">
	<form class="form form-horizontal" enctype="multipart/form-data" onsubmit="return checkvolide();" id="form-activity-add" method="post" action="<%=path%>/activity/upfile">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  required  placeholder="请输入活动标题"  onblur="checktitle(this.value);" id="activity_titleString" name="activity.titleString">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" value="" required  placeholder="请输入活动开始时间" onblur="checkstarttime(this.value);" id="activity_startTime" name="activity.startTime">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" value="" required  placeholder="请输入活动结束时间" id="activity_endTime" onblur="checkendtime(this.value);" name="activity.endTime">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<textarea name="activity.contentString" required  id="editor" style="width:100%;height:400px;"></textarea>
			</div>
		</div>
		<div class="row cl">
